                            ...
                            <table class="table align-middle table-hover mb-0">
                                ...
                                @forelse ($gyms as $gym)
                                    <tr id="gym_{{ $gym->id }}">
                                        ...
                                        <td class="text-end">
                                            <button class="btn btn-outline-warning btn-outline-sm" wire:click="editGym({{ $gym->id }})" title="Редактировать">
                                                <span class="material-symbols-rounded">edit</span>
                                            </button>
                                            <button class="btn btn-outline-danger btn-outline-sm" wire:click="showDeleteModal({{ $gym->id }})" title="Удалить">
        ...
        <div class="modal fade show" tabindex="-1" style="display: block;">
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-outline-secondary" wire:click="closeModal">Отмена</button>
                        <button type="button" class="btn btn-outline-danger" wire:click="deleteGym({{ $gymId }})">Удалить</button>
                    </div>
                </div>
            </div>
        </div>
