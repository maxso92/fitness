...
@section('title')
    <title>Дашборд</title>
@endsection
@if(in_array(auth()->user()->role, ['client', 'trainer']))
                    ...
                    <div class="card-body">
                        ...
                        @if($showQrSection)
                            <div class="text-center mb-4 border-bottom pb-3">
                                <h5 class="mb-2">QR-код для доступа в клуб</h5>
                        ...
                        @if($user->role === 'client' && !empty($user->trainer))
                            <div class="mt-3">
                                <div class="mb-2 small text-muted">
                                    <span class="align-middle material-symbols-rounded me-2 fs-4">sports</span>Ваш тренер:
                                </div>
                                <p class="mb-0">
